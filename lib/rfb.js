...
var RFB = function (_EventTargetMixin) {
    ...
    function RFB(target, url, options, window) {
        ...
        _this._url = url;
        _this.openedModalWindow = window;
    ...
    _createClass(RFB, [{
        ...
        value: function _connect() {
            ...
            this.openedModalWindow.window.addEventListener('resize', this._eventHandlers.windowResize);
        ...
        value: function _disconnect() {
            ...
            this.openedModalWindow.window.removeEventListener('resize', this._eventHandlers.windowResize);
        ...
        value: function _windowResize(event) {
            ...
            this.openedModalWindow.window.requestAnimationFrame(function () {
				_this2._updateClip();
				_this2._updateScale();
			});
